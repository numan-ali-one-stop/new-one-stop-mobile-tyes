...
const _serviceSchema = serviceSchema({
  slug: 'mobile-tyre-fitting-irlam-o-th-height',
  name: "Mobile Tyre Fitting Irlam o' th' Height",
  serviceType: 'Mobile Tyre Fitting',
  areaServed: { '@type': 'City', name: "Irlam o' th' Height" },
})

export const metadata = buildMetadata({
  title: "Mobile Tyre Fitting Irlam o' th' Height | One Stop Mobile Tyres 24/7",
  description:
    "Professional mobile tyre fitting in Irlam o' th' Height — emergency replacement, dependable service.",
  path: '/mobile-tyre-fitting-irlam-o-th-height',
})
...
export default function IrlamOThHeightPage() {
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                "Covering Irlam o' th' Height & Surrounding Areas 24/7",
              ...
              {[
                {
                  ...
                  desc: "Mobile tyre fitting at your home, workplace or roadside location anywhere in Irlam o' th' Height. Fast response with premium and budget tyre options available.",
                  badge: 'FAST RESPONSE',
                ...
                },
                {
                  ...
                  desc: "Same day tyre fitting at your home across Irlam o' th' Height, without the hassle of visiting a garage.",
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  title: 'Jump Start',
                  desc: "Flat battery as well as a flat tyre? Our mobile jump start service gets you back on the road in minutes, available 24/7 across Irlam o' th' Height.",
                  badge: '24/7 SERVICE',
                  href: '/jump-start',
                },
                {
                  ...
                  title: 'TPMS Reset',
                  desc: "Tyre pressure monitoring system reset and sensor checks across Irlam o' th' Height after every fitting or repair.",
                  badge: 'ALL VEHICLES',
                  href: '/tpms-reset',
                },
                {
        ...
        {/* ── 5. WHY IRLAM O' TH' HEIGHT DRIVERS CHOOSE US ──────────────── */}
        <WhyChooseUs city="Irlam o' th' Height" image="/images/tyres-fitting-anywhere.webp" />

        {/* ── 6. BRAND CAROUSEL ─────────────────────────────── */}
        <BrandCarousel />

        {/* ── NEARBY AREAS ───────────────────────────────────── */}
        <NearbyAreas currentSlug="irlam-o-th-height" />
        ...
        {/* ── 7. FAQ ────────────────────────────────────────── */}
        <CityFaq
          canonical="https://onestoptyres247.co.uk/mobile-tyre-fitting-irlam-o-th-height"
          city="Irlam o' th' Height"
          faqs={[
            {
              q: "How quickly can you reach me in Irlam o' th' Height?",
              a: "Our mobile units are based close by in Salford, meaning we can typically reach Irlam o' th' Height and the surrounding M27 postcode area, including Bolton Road, within 20-30 minutes.",
            },
            {
              q: "What areas around Irlam o' th' Height do you cover?",
              a: "Yes. We cover Irlam o' th' Height and the surrounding M27 postcode area, along with Bolton Road and the routes connecting to Swinton and Pendlebury.",
            },
            {
              q: "Can you repair a puncture instead of replacing my tyre in Irlam o' th' Height?",
            ...
            {
              q: "Can you fit tyres at my workplace near Bolton Road or Swinton?",
              a: "Yes. We regularly attend offices and business premises around Bolton Road and Swinton, fitting your tyres while you work.",
            },
          ]}
        />
