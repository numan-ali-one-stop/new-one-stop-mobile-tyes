  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
        ...
        <section className="relative min-h-[100svh] lg:min-h-[600px] flex items-center justify-start text-left px-4 sm:px-8 lg:px-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            <p className="text-white/80 text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance Across Hulme. We Come To Your Home, Workplace Or Roadside Location Within 20–30 Minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                'Covering Hulme &amp; Surrounding Areas 24/7',
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-work-sans)' }}
              >
                Expert Mobile Tyre Fitting Service Across Hulme
              </h2>
              <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                One Stop Tyres provides 24/7 mobile tyre fitting in Hulme, helping drivers get back on the road quickly when they experience a puncture, tyre blowout or damaged tyre.
                Our mobile tyre experts come directly to your home, workplace or roadside location anywhere in Hulme and surrounding areas.
                We supply and fit premium and budget tyres, carry out mobile puncture repairs where safe and suitable, and provide emergency tyre replacement services throughout Hulme.
                If you&apos;re searching for mobile tyre fitting near me in Hulme, our fast response team is available day and night.
              </p>
        ...
        <WhyChooseUs city="Hulme" image="/images/tyres-fitting-anywhere.webp" />
          ...
          faqs={[
            {
              ...
              a: 'Our mobile units are strategically positioned across central Manchester, meaning we can typically reach Hulme and the surrounding M15 postcode area, including Stretford Road and Hulme Park, within 20-30 minutes.',
            },
            {
              q: 'What areas around Hulme do you cover?',
              a: 'Yes. We cover Hulme and the surrounding M15 postcode area, along with Stretford Road, Royce Road and the routes connecting to Manchester city centre and Old Trafford.',
            },
            {
              q: 'Do you fit tyres for electric vehicles in Hulme?',
              a: 'Yes. Our vans are equipped with the correct jacking points and reinforced tyre stock for electric and hybrid vehicles, and every technician is trained in EV-specific fitting.',
            },
            {
              q: 'Can you fit tyres at my workplace near Hulme Park or Stretford Road?',
              a: 'Yes. We regularly attend offices and business premises around Hulme Park and Stretford Road, fitting your tyres on-site.',
            },
          ]}
        />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-h2 text-xl sm:text-2xl lg:text-h2 mb-4 sm:mb-5 leading-tight">Need a Tyre Fitted in Hulme Right Now?</h2>
            <p className="font-body-lg text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait by the roadside. Call our dedicated Hulme line and get a technician dispatched in minutes.</p>
