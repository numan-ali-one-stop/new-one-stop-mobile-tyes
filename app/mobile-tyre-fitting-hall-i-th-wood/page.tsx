...
const _serviceSchema = serviceSchema({
  slug: 'mobile-tyre-fitting-hall-i-th-wood',
  name: "Mobile Tyre Fitting Hall i' th' Wood",
  serviceType: 'Mobile Tyre Fitting',
  areaServed: { '@type': 'City', name: "Hall i' th' Wood" },
})

export const metadata = buildMetadata({
  title: "Mobile Tyre Fitting Hall i' th' Wood | One Stop Mobile Tyres 24/7",
  description:
    "Professional mobile tyre fitting in Hall i' th' Wood — emergency replacement, dependable service.",
  path: '/mobile-tyre-fitting-hall-i-th-wood',
})
...
export default function HallInThWoodPage() {
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                "Covering Hall i' th' Wood & Surrounding Areas 24/7",
              ...
              {[
                {
                  ...
                  desc: "Mobile tyre fitting at your home, workplace or roadside location anywhere in Hall i' th' Wood. Fast response with premium and budget tyre options available.",
                  badge: 'FAST RESPONSE',
                ...
                },
                {
                  ...
                  desc: "Same day tyre fitting at your home across Hall i' th' Wood, without the hassle of visiting a garage.",
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: "Professional mobile puncture repair across Hall i' th' Wood, carried out on-site where safe and suitable.",
                ...
                },
                {
                  ...
                  title: 'Jump Start',
                  desc: "Flat battery as well as a flat tyre? Our mobile jump start service gets you back on the road in minutes, available 24/7 across Hall i' th' Wood.",
                  badge: '24/7 SERVICE',
                  href: '/jump-start',
                },
                {
                  ...
                  title: 'TPMS Reset',
                  desc: "Tyre pressure monitoring system reset and sensor checks across Hall i' th' Wood after every fitting or repair.",
                  badge: 'ALL VEHICLES',
                  href: '/tpms-reset',
                },
                {
                  ...
                  desc: "Specialist, damage-free locking wheel nut removal across Hall i' th' Wood using professional tools.",
                  badge: 'DAMAGE FREE',
                ...
                },
                {
                  ...
                  desc: "Emergency roadside support for tyre and vehicle problems across Hall i' th' Wood, wherever you get stranded.",
                  badge: '24/7 SUPPORT',
        ...
        {/* ── 5. WHY HALL I' TH' WOOD DRIVERS CHOOSE US ──────────────── */}
        <WhyChooseUs city="Hall i' th' Wood" image="/images/tyres-fitting-anywhere.webp" />

        {/* ── 6. BRAND CAROUSEL ─────────────────────────────── */}
        <BrandCarousel />

        {/* ── NEARBY AREAS ───────────────────────────────────── */}
        <NearbyAreas currentSlug="hall-i-th-wood" />
        ...
        {/* ── 7. FAQ ────────────────────────────────────────── */}
        <CityFaq
          canonical="https://onestoptyres247.co.uk/mobile-tyre-fitting-hall-i-th-wood"
          city="Hall i' th' Wood"
          faqs={[
            {
              q: "How quickly can you reach me in Hall i' th' Wood?",
              a: "Our mobile units are based close by in Bolton, meaning we can typically reach Hall i' th' Wood and the surrounding BL1 and BL2 postcode areas, including Crompton Way and the historic hall, within 20-30 minutes.",
            },
            {
              q: "What areas around Hall i' th' Wood do you cover?",
              a: "Yes. We cover Hall i' th' Wood and the surrounding BL1 and BL2 postcode areas, along with Crompton Way and the routes connecting to Astley Bridge and Tonge Moor.",
            },
            {
              q: "Can you repair a puncture instead of replacing my tyre in Hall i' th' Wood?",
            ...
            {
              q: "Can you fit tyres at my workplace near Crompton Way or the historic hall?",
              a: "Yes. We regularly attend offices and business premises around Crompton Way and the Hall i' th' Wood area, fitting your tyres while you work.",
            },
          ]}
        />
