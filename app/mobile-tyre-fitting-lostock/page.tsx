...
const _serviceSchema = serviceSchema({
  slug: 'mobile-tyre-fitting-lostock',
  name: 'Mobile Tyre Fitting Lostock',
  serviceType: 'Mobile Tyre Fitting',
  areaServed: { '@type': 'City', name: 'Lostock' },
})

export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting Lostock | One Stop Mobile Tyres 24/7',
  description:
    'Professional mobile tyre fitting in Lostock — emergency replacement, dependable service.',
  path: '/mobile-tyre-fitting-lostock',
})
...
export default function LostockPage() {
  return (
      ...
      <main>
        ...
        <section className="relative min-h-[100svh] lg:min-h-[600px] flex items-center justify-start text-left px-4 sm:px-8 lg:px-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            >
              24/7 Mobile Tyre Fitting Lostock
            </h1>

            <p className="text-white/80 text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance Across Lostock. We Come To Your Home, Workplace Or Roadside Location Within 20–30 Minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                'Covering Lostock &amp; Surrounding Areas 24/7',
            ...
            <a href="https://maps.app.goo.gl/tqGMogzsNNn8EXjH8" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-white/60 text-xs font-medium">Rated By Drivers Across Lostock &amp; Greater Manchester</span>
            </a>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-work-sans)', letterSpacing: '-0.01em' }}
              >
                24/7 Mobile Tyre Fitting &amp; Emergency Tyre Repair In Lostock
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto text-base">
                Mobile tyre fitting, emergency tyre replacement and puncture repair across Lostock. We come to your home, workplace or roadside location 24/7 with fast response times and professional service.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Mobile tyre fitting at your home, workplace or roadside location anywhere in Lostock. Fast response with premium and budget tyre options available.',
                  badge: 'FAST RESPONSE',
                ...
                },
                {
                  ...
                  desc: 'Same day tyre fitting at your home across Lostock, without the hassle of visiting a garage.',
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: 'Professional mobile puncture repair across Lostock, carried out on-site where safe and suitable.',
                ...
                },
                {
                  ...
                  title: 'Jump Start',
                  desc: 'Flat battery as well as a flat tyre? Our mobile jump start service gets you back on the road in minutes, available 24/7 across Lostock.',
                  badge: '24/7 SERVICE',
                  href: '/jump-start',
                },
                {
                  ...
                  title: 'TPMS Reset',
                  desc: 'Tyre pressure monitoring system reset and sensor checks across Lostock after every fitting or repair.',
                  badge: 'ALL VEHICLES',
                  href: '/tpms-reset',
                },
                {
                  ...
                  desc: 'Specialist, damage-free locking wheel nut removal across Lostock using professional tools.',
                  badge: 'DAMAGE FREE',
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside support for tyre and vehicle problems across Lostock, wherever you get stranded.',
                  badge: '24/7 SUPPORT',
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-work-sans)' }}
              >
                Expert Mobile Tyre Fitting Service Across Lostock
              </h2>
              <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                One Stop Tyres provides 24/7 mobile tyre fitting in Lostock, helping drivers get back on the road quickly when they experience a puncture, tyre blowout or damaged tyre.
                Our mobile tyre experts come directly to your home, workplace or roadside location anywhere in Lostock and surrounding areas.
                We supply and fit premium and budget tyres, carry out mobile puncture repairs where safe and suitable, and provide emergency tyre replacement services throughout Lostock.
                If you&apos;re searching for mobile tyre fitting near me in Lostock, our fast response team is available day and night.
              </p>
        ...
        {/* ── 5. WHY LOSTOCK DRIVERS CHOOSE US ──────────────── */}
        <WhyChooseUs city="Lostock" image="/images/tyres-fitting-anywhere.webp" />

        {/* ── 6. BRAND CAROUSEL ─────────────────────────────── */}
        <BrandCarousel />

        {/* ── NEARBY AREAS ───────────────────────────────────── */}
        <NearbyAreas currentSlug="lostock" />
        ...
        {/* ── 7. FAQ ────────────────────────────────────────── */}
        <CityFaq
          canonical="https://onestoptyres247.co.uk/mobile-tyre-fitting-lostock"
          city="Lostock"
          faqs={[
            {
              q: 'How quickly can you reach me in Lostock?',
              a: 'Our mobile units are based close by in Bolton, meaning we can typically reach Lostock and the surrounding BL6 postcode area, including Chorley New Road and the Lostock estate, within 20-30 minutes.',
            },
            {
              q: 'What areas around Lostock do you cover?',
              a: 'Yes. We cover Lostock and the surrounding BL6 postcode area, along with Chorley New Road and the routes connecting to Horwich and Middlebrook.',
            },
            {
              q: 'Can you repair a puncture instead of replacing my tyre in Lostock?',
            ...
            {
              q: 'Can you fit tyres at my workplace near Chorley New Road or Middlebrook?',
              a: 'Yes. We regularly attend offices and business premises around Chorley New Road and Middlebrook, fitting your tyres while you work.',
            },
          ]}
        />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-h2 text-xl sm:text-2xl lg:text-h2 mb-4 sm:mb-5 leading-tight">Need a Tyre Fitted in Lostock Right Now?</h2>
            <p className="font-body-lg text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait by the roadside. Call our dedicated Lostock line and get a technician dispatched in minutes.</p>
