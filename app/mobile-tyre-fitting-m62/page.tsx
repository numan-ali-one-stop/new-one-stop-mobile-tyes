...
const _serviceSchema = serviceSchema({
  ...
  name: 'Mobile Tyre Fitting on the M62',
  serviceType: 'Emergency Roadside Tyre Fitting',
  areaServed: { '@type': 'Place', name: 'M62' },
})

export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting M62 | 24/7 Motorway Tyre Assistance',
  description:
    'Fast mobile tyre fitting on the M62 — trusted tyre fitters, quick roadside support ready.',
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
        ...
        <section className="relative min-h-[100svh] lg:min-h-[600px] flex items-center justify-start text-left px-4 sm:px-8 lg:px-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            <p className="text-white/80 text-base leading-relaxed mb-6">
              Emergency Tyre Replacement &amp; Mobile Puncture Repair for the M62. Get to a safe place — a services, slip road or lay-by — and we&apos;ll reach you within 20–30 minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                'Covering the M62 & Surrounding Areas 24/7',
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-work-sans)' }}
              >
                Expert Mobile Tyre Fitting Service On the M62
              </h2>
              <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                One Stop Tyres provides 24/7 mobile tyre fitting on the M62, helping drivers get back on the road quickly when they experience a puncture, tyre blowout or damaged tyre. Our mobile tyre experts come directly to your location on the M62 and surrounding areas. We supply and fit premium and budget tyres, carry out mobile puncture repairs where safe and suitable, and provide emergency tyre replacement services throughout the M62. If you&apos;re searching for mobile tyre fitting near me on the M62, our fast response team is available day and night.
              </p>
        ...
        {/* ── 5. WHY CHOOSE US ──────────────────────────────── */}
        <WhyChooseUs city="M62" image="/images/tyre-fitting-in-emergency.webp" locationType="road" />
        ...
        <CityFaq
          ...
          faqs={[
            ...
            { q: 'Can you attend the M62 service stations?', a: 'Absolutely. We attend Birch Services, Hartshead Moor Services, Ferrybridge Services, and Burtonwood Services. If you can safely reach any of these, we can fit your tyre in the car park.' },
            { q: 'What is your average response time on the M62?', a: 'Our average arrival time is 20-30 minutes. Our strategic positioning near J18 (Simister Island) and J22 (Rishworth Moor) ensures we can reach most M62 locations quickly.' },
            { q: 'Do you carry commercial van tyres for the M62?', a: 'Yes, every van in our fleet carries a range of commercial-rated tyres suitable for all popular van makes and models used on the M62 Trans-Pennine route.' },
          ]}
        />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait on the hard shoulder. Call our dedicated M62 line and get a technician dispatched in minutes.</p>
