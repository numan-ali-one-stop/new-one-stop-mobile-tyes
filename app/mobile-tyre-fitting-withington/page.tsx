...
export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting in Withington | One Stop Mobile Tyres 24/7',
  description:
    'Professional mobile tyre fitting in Withington — emergency replacement, dependable service.',
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
        ...
        <section className="relative min-h-[100svh] lg:min-h-[600px] flex items-center justify-start text-left px-4 sm:px-8 lg:px-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl py-20">
            ...
            <p className="text-white/80 text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance Across Withington. We Come To Your Home, Workplace Or Roadside Location Within 20–30 Minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                'Covering Withington &amp; Surrounding Areas 24/7',
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-work-sans)' }}
              >
                Expert Mobile Tyre Fitting Service Across Withington
              </h2>
              <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                One Stop Tyres provides 24/7 mobile tyre fitting in Withington, helping drivers get back on the road quickly when they experience a puncture, tyre blowout or damaged tyre.
                Our mobile tyre experts come directly to your home, workplace or roadside location anywhere in Withington and surrounding areas.
                We supply and fit premium and budget tyres, carry out mobile puncture repairs where safe and suitable, and provide emergency tyre replacement services throughout Withington.
                If you&apos;re searching for mobile tyre fitting near me in Withington, our fast response team is available day and night.
              </p>
        ...
        {/* ── 5. WHY WITHINGTON DRIVERS CHOOSE US ──────────────── */}
        <WhyChooseUs city="Withington" image="/images/tyres-fitting-anywhere.webp" />
          ...
          faqs={[
            {
              ...
              a: 'Our mobile units are strategically positioned across south Manchester, meaning we can typically reach Withington and the surrounding M20 postcode area, including Wilmslow Road and Burton Road, within 20-30 minutes.',
            },
            {
              q: 'What areas around Withington do you cover?',
              a: 'Yes. We cover Withington and the surrounding M20 postcode area, along with Wilmslow Road, Burton Road and the routes connecting to Didsbury and Fallowfield.',
            },
            {
              q: 'Can you repair a puncture instead of replacing my tyre in Withington?',
            ...
            {
              q: 'Can you fit tyres at my workplace near Christie Hospital or Burton Road?',
              a: 'Yes. We regularly attend offices and business premises around Christie Hospital and Burton Road, fitting your tyres while you work.',
            },
          ]}
        />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-h2 text-xl sm:text-2xl lg:text-h2 mb-4 sm:mb-5 leading-tight">Need a Tyre Fitted in Withington Right Now?</h2>
            <p className="font-body-lg text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait by the roadside. Call our dedicated Withington line and get a technician dispatched in minutes.</p>
